...
export default function PickTeamLoginDetailScreen ({route, navigation}){

    function go_pickteamdetail(teamname){
        navigation.navigate('MakeID', {groupVal: route.params.groupVal, teamVal: teamname});
    };
