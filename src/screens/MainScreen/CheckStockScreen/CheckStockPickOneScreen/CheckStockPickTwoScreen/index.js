...
export default function CheckStockPickTwoScreen ({route, navigation}){
    const [userConfigdata, setuserConfigdata] = React.useState(route.params.configdata);

    function go_stockchange(teamname){
        navigation.navigate('CheckStockFinal', {groupVal: route.params.groupVal, teamVal: teamname, configdata:userConfigdata});
    };
